...
export default function Home() {
  ...
  const validateInputs = () => {
    if (city && (latitude || longitude)) {
      setError(
        "Please enter either a city name or latitude and longitude, not both."
      );
      return false;
    } else {
      setError("");
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="relative bg-white/10 backdrop-blur-lg text-white p-12 rounded-2xl shadow-2xl w-[650px] border border-white/20 transition-all duration-300 hover:scale-105">
        ...
        <input
          ...
          className="w-full p-4 bg-white/10 border border-white/20 rounded-lg mb-3 focus:ring-2 focus:ring-white text-white placeholder-white/60"
          value={city}
          onChange={(e) => {
        ...
        {/* OR Divider */}
        <div className="text-center text-white/80 my-3 font-semibold text-lg">
          OR
        </div>
        ...
        <div className="flex space-x-4">
          <input
            ...
            className="w-1/2 p-4 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-white text-white placeholder-white/60"
            value={latitude}
            onChange={(e) => {
