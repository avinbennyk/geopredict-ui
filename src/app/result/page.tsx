...
export default function Result() {
  ...
  const confidence = parseFloat(router.query.confidence as string || "50");
  const prediction = router.query.prediction as string || "No Landslide";
  const weatherDetails = JSON.parse(router.query.weather as string || "{}");
  ...
  const needlePlugin = {
    ...
    beforeDraw(chart: any) {
      ...
      const centerY = chartArea.bottom - 15;
